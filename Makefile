all: ev3dev.a practice.o h_crane.o
	arm-linux-gnueabi-g++-4.7 -L. -o practice practice.o h_crane.o -lev3dev
...
practice.o: practice.cpp
		arm-linux-gnueabi-g++-4.7 -c practice.cpp -o practice.o -std=c++11 -D_GLIBCXX_USE_NANOSLEEP
