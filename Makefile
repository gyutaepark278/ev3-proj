all: ev3dev.a motpos.o h_crane.o
	arm-linux-gnueabi-g++-4.7 -L. -o motpos motpos.o h_crane.o -lev3dev
...
motpos.o: motpos.cpp
		arm-linux-gnueabi-g++-4.7 -c motpos.cpp -o motpos.o -std=c++11 -D_GLIBCXX_USE_NANOSLEEP
