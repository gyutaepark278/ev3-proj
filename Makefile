all: ev3dev.a mottime.o h_crane.o
	arm-linux-gnueabi-g++-4.7 -L. -o mottime mottime.o h_crane.o -lev3dev

ev3dev.a: ev3dev.cpp 
	arm-linux-gnueabi-g++-4.7 -c ev3dev.cpp -o ev3dev.o -std=c++11 -D_GLIBCXX_USE_NANOSLEEP
	ar -r libev3dev.a ev3dev.o

mottime.o: mottime.cpp
		arm-linux-gnueabi-g++-4.7 -c mottime.cpp -o mottime.o -std=c++11 -D_GLIBCXX_USE_NANOSLEEP
